...
global.botLanguage = "default" // 𝗗𝗲𝗳𝗮𝘂𝗹𝘁 || 𝗘𝗻𝗴𝗹𝗶𝘀𝗵 || 𝗛𝗶𝗻𝗱𝗶 || 𝗔𝗿𝗮𝗯𝗶𝗰 || 𝗦𝗶𝗻𝗵𝗮𝗹𝗮 \\
global.author = "卩卂丂丨几ᗪㄩ"  
global.packname = "🥵𝙌𝙐𝙀𝙀𝙉✯𝘼𝙉𝙔𝘼✯𝘽𝙊𝙏"  
global.myweb = "https://github.com/pkavishka/Anya-pika-MD-v2" // You can put any link 
global.waterMark = "×͜× 🥵King ✘ ᴘᴀꜱɪɴᴅᴜ💫™ ✓" // Your own watermark 
global.headerText = "Anya by Pasindu" // text for header of menu         
global.DocumentTitle = "🥵MASTER⚔️𝗣𝗔𝗦𝗜𝗡𝗗𝗨 🦄" 


global.ownername = "⚔️𝗣𝗔𝗦𝗜𝗡𝗗𝗨🥵"   // Owner name //        
global.ownernumber = ['94767120549'] 
global.socialm = "𝗜𝗻𝘀𝘁𝗮 : 3.69_pika" // 𝗜𝗻𝘀𝘁𝗮 : || 𝗚𝗶𝘁𝗵𝘂𝗯 : || 𝗙𝗮𝗰𝗲𝗯𝗼𝗼𝗸 : \\
global.ytname = "YT: 𝗣𝗮𝘀𝗶𝗻𝗱𝘂"   // Yt chanel name //
global.continent = "Asia" // your continent name 
global.region = "Sri Lanka" // your country name
global.state = "Sri Lanka" // your state name
...
global.instagramId = "⚔️𝗣𝗔𝗦𝗜𝗡𝗗𝗨🥵" // Your insta ID
global.email = "example@exmaple.com" // put your email here


//------------ 🌟 Premium Users 🌟-------------\\
global.premium = ['94767120549']  // available soon
global.sudo = ['94767120549']  // Co - Owners //
